 ...
 * @since 1.0.0
 */
class BQW_SliderPro_Lite_Updates {
	...
	public function __construct() {
		$this->db_version = get_option( 'sliderpro_lite_version', '1.0.0' );

		if ( version_compare( $this->db_version, BQW_SliderPro_Lite::VERSION, '>=' ) ) {
			return;
		}
	...
	private function single_update() {
		update_option( 'sliderpro_lite_version', BQW_SliderPro_Lite::VERSION );
	}
}